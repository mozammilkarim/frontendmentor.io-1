    ...
    return(
        <div className='flex flex-col items-start justify-between  cursor-pointer relative hover:opacity-75 opacity-100' onMouseEnter={()=>setHover(true)} onMouseLeave={()=>setHover(false)}>
                    ...
                    <div className='absolute opacity-100 m-auto md:flex hidden flex-col items-center w-full justify-center h-[80%] gap-8' >
                        <a href='mailto:mozammilkarim@gmail.com' className={`w-fit inline-block underline hover:text-[#4EE1A0]  decoration-[#4EE1A0]  underline-offset-[10px] text-base m-auto sm:m-0 sm:text-start text-white  font-bold ${hover?"inline-block opacity-100":"hidden"}`}>VIEW PROJECT</a>
                        <a href='mailto:mozammilkarim@gmail.com' className={`w-fit inline-block underline hover:text-[#4EE1A0]  decoration-[#4EE1A0]  underline-offset-[10px] text-base m-auto sm:m-0 sm:text-start text-white  font-bold ${hover?"inline-block opacity-100":"hidden"}`}>VIEW CODE</a>
