    ...
    return (
        <div className='flex flex-col px-10 xl:px-0 xl:w-[80%] w-[95%]  justify-center items-center sm:m-auto m-0 sm:relative'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-2 w-full' >
                {skillArr.map((skill) => {
                    return (
                        <div key={skill.name} className='flex flex-col justify-start items-center sm:items-start text-center sm:text-start p-10 sm:pl-0'>
            ...
            <div className='relative '>
                <img src={patternRings} alt="rings" className='absolute h-[8rem]  md:h-[8rem] sm:absolute  bottom-32 left-[120%] ' />
